...
| Repository role | Contents | Planned stack | Path / URL |
| --- | --- | --- | --- |
| Orchestration | 공통 문서, 계약, ADR, 통합 구성 | Markdown, future Docker Compose | 현재 디렉터리 |
...
- [ ] 오케스트레이션 저장소 Git 초기화
- [ ] submodule 연결
- [ ] clone / update / integration 검증 절차 문서화
